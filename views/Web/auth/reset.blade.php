        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-4">please set new password </p>
                    <!-- <h4 class="mb-2">Welcome to {{app('config.app')['name']}}! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p> -->

                    <form id="formAuthentication" class="mb-3" action="./{{$code}}" method="POST">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary d-grids w-100 btn-submit text-center" type="submit">change password</button>
